$(function(){
  ...
  // turns the App into the "this" of whatever fn is 
  ...
  App.doThis(function(){
    ...
    $("#todos").on("click", ".todo", function(event){
      ...
      if(event.target.id === "removeTodo"){
        var viewid = this;
        var todoid =  _this.findModel(id);
        // DELETE ITEM
        _this.deleteItem(todoid, function(){
          _this.removeModel(todoid);
  ...
  //loops thorugh each todo and display's the data
  App.doThis(function() {
    var _this = this;
